<?PHP // $Id: leaveschool.php,v 1.2 2009/10/13 07:30:10 Shtifanov Exp $
    ...
    $fullname = fullname($user);
 	...
 	if ($delete and confirm_sesskey()) {              // Delete a selected user, after confirmation
        ...
        if ($confirm != md5($delete)) {
	        ...
	        notice_yesno(get_string('leavecheckfull', 'block_mou_school', "'$fullname'"), 'leaveschool.php', $CFG->wwwroot.'/blocks/mou_mi/class/classpupils.php', $optionsyes, $optionsyes, 'post', 'get');
